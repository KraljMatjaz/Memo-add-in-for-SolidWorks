...
namespace SolidDNA.Memo.AddIn
{
    ...
    //        output dll file (for example /bin/Debug/SolidDNA.Memo.AddIn.dll) and click Install.
    //
    ...
    /// </summary>
    [Guid("0BEA0945-6EAE-4C87-9E8E-E998984E80B4"), ComVisible(true)]  // Replace the GUID with your own.
    ...
    public class MySolidDnaPlugIn : SolidPlugIn<MySolidDnaPlugIn>
    {
        ...
        /// My Add-in title
        /// </summary>
        public override string AddInTitle => "SolidWorks memo app by Mtron";

        /// <summary>
        /// My Add-in description
        /// </summary>
        public override string AddInDescription => "SolidDNA based memo Add-In by Mtron. Dumbs remember. Smarts write it down.";
        ...
        public override void ConnectedToSolidWorks()
        {
            ...
            {
                // Set taskpane icon
                Icon = Path.Combine(this.AssemblyPath(), "Resources/icon.png"),
